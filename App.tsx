...
import { generateOptimizedPrompt, verifyPassword } from './services/geminiService';
...
const App: React.FC = () => {
    ...
    const handleLogin = async (password: string) => {
        ...
        if (result.success) {
            ...
            setAuthError(result.message || '알 수 없는 오류가 발생했습니다.');
        }
    ...
    if (!isAuthenticated) {
        return <PasswordScreen onPasswordSubmit={handleLogin} error={authError} isLoading={isAuthenticating} />;
    }
